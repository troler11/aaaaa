...
/**
 * Configura o cURL para máxima velocidade
 */
if (!function_exists('curl_fast_setup')) {
 ...
 */
if (!function_exists('garantir_aquecimento')) {
...
// ==============================================================================
// 3. FUNÇÕES DE NEGÓCIO (Com verificação se já existem)
// ==============================================================================

if (!function_exists('limpar_placa')) {
    function limpar_placa($placa) {
        return preg_replace("/[^A-Za-z0-9]/", '', strtoupper($placa));
    }
}

// AQUI ESTAVA O ERRO: Adicionei verificação para não redeclarar
...
if (!function_exists('get_veiculo_posicao')) {
...
if (!function_exists('get_dados_dashboard_cached')) {
...
if (!function_exists('calcular_rota_tomtom')) {
...
// ==============================================================================
// 4. HANDLERS (Controladores) - Estes nunca repetem pois são específicos daqui
// ==============================================================================

if (!function_exists('handle_buscar_rastreamento')) {
...
if (!function_exists('handle_calcular_rota')) {
